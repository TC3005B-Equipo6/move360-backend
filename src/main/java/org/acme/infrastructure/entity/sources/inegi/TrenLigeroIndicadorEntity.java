...
@Entity
@Table(name = "i_tren_ligero")
public class TrenLigeroIndicadorEntity {
    ...
    public TrenLigeroIndicadorEntity() {}

    public TrenLigeroIndicadorEntity(int id, int year, int month, int operations, BigDecimal kmTraveled, int passengers, BigDecimal fareRevenue) {
        this.id = id;
        this.year = year;
        this.month = month;
