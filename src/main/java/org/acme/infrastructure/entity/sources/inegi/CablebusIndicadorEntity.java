...
@Entity
@Table(name = "i_cablebus")
public class CablebusIndicadorEntity {
    ...
    public CablebusIndicadorEntity() {}

    public CablebusIndicadorEntity(int id, int year, int month, int routes, int operationsWeek, int operationsWeekend, BigDecimal kmTraveled, int fullFarePassengers, int courtesyPassengers) {
        this.id = id;
        this.year = year;
        this.month = month;
        this.routes = routes;
